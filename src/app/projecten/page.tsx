        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-3 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-wrap gap-2.5">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-foreground/20 bg-background px-6 py-3 text-base font-medium text-foreground transition-colors hover:border-foreground/40 hover:bg-foreground/5"
            >
              Verbouw &amp; renovatie
