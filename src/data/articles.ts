...
export const articles: Article[] = [
  ...
  },
  {
    ...
    "body": "Op maandag 27 augustus staan onze collega’s vanaf 08.30 uur weer voor je klaar. Alle medewerkers van Bouwbedrijf Homan wensen je een fijne zomer!"
  },
  {
  ...
  },
  {
    ...
    "body": "Wederom een mooi project waar we vol enthousiasme aan gaan werken.  Heb je interesse in een soortgelijke woning? Neem dan gerust contact met ons op via onderstaande contactgegevens. We gaan graag vrijblijvend met je in gesprek om de mogelijkheden te bespreken.\n\n![](/images/actueel/start-bouw-buitengebied-enter/01.jpg)\n\n![](/images/actueel/start-bouw-buitengebied-enter/02.jpg)\n\n[![](/images/actueel/start-bouw-buitengebied-enter/03.jpg)](https://www.bouwbedrijfhoman.nl/wp-content/uploads/2018/08/Woning-Enter.jpg)"
  },
  {
    ...
    "body": "Met trots presenteren we onze nieuwe bedrijfsfilm! We laten je van A tot Z zien hoe wij op traditionele wijze toewerken naar een hoogwaardig pand.\n\n[Bekijk onze bedrijfsfilm](/over-ons/)"
  }
];
